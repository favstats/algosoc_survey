...
<ul class="details-content" style="margin-top: 1em; padding-left: 20px; display: none;"><li>Item 1: I recognize it when a website or app uses AI to adapt the content to me.</li>
<li>Item 2: I recognize it when specific content is recommended to me by AI.</li>
<li>Item 3: I know where to find the settings to change or disable AI personalization.</li>
<li>Item 4: I know how to access the data that AI systems use to tailor content to me.</li>
<li>Item 5: I know how I can influence what content is recommended to me by AI.</li></ul></blockquote>
::: {.panel-tabset}
# Over Time
```{r}
var_labels <-
...
<button class="collapse-button" type="button"><span class="arrow"></span></button>
<ul class="details-content" style="margin-top: 1em; padding-left: 20px; display: none;"><li>Item 1: ...text generators like ChatGPT?</li>
<li>Item 2: ...image generators like Midjourney?</li></ul></blockquote>
::: {.panel-tabset}
# Over Time
```{r}
var_labels <-
...
<button class="collapse-button" type="button"><span class="arrow"></span></button>
<ul class="details-content" style="margin-top: 1em; padding-left: 20px; display: none;"><li>Item 1: Texts made by AI</li>
<li>Item 2: Photos or images made by AI</li>
<li>Item 3: Videos made by AI</li></ul></blockquote>
::: {.panel-tabset}
# Over Time
```{r}
var_labels <-
...
<button class="collapse-button" type="button"><span class="arrow"></span></button>
<ul class="details-content" style="margin-top: 1em; padding-left: 20px; display: none;"><li>Item 1: Generative AI</li>
<li>Item 2: ChatGPT</li>
<li>Item 3: Deepfakes</li>
<li>Item 4: Algorithms</li>
